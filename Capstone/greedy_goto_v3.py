...
class GreedyGoto(ss.Tactic):
    ...
    def step_autonomy(self, t, dt):
        ...
        if self._first_tick == True:
            ...
            server_address = ('192.168.11.203',11000) # Changed from 10000 to 11000
        ...
        if self._vehicle_type == 1 and dist < DIST_START_DESCENT: 
            self._desired_alt = self._base_alt + (self._alt_change * self._id_in_subswarm.index(self._id)) #sam g change 
        ...
        if self._time_at_wp > TIME_AT_WP:
            ...
            try:
                #send data
                #message = str(self._id)+" "+str(self._wp_id_list_id)
