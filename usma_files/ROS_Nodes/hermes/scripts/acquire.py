...
class AcquisitionNode(object):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('/tactic_interface/radiation', radData, queue_size=10)
        print "note started, publishing on /rad_data"
...
# print 'G: ', data['mca'][0]['ga_counts'][0], "N: ", data['mca'][0]['ne_counts'][0], int(stamp-time_start)
            ...
            # I think dose rate is reported in uR/h, but as an intiger value...
