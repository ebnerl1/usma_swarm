...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ap_srvs-srv:<Trigger-request> is deprecated: use ap_srvs-srv:Trigger-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ap_srvs-srv:<Trigger-response> is deprecated: use ap_srvs-srv:Trigger-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Trigger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ap_srvs-srv:success-val is deprecated.  Use ap_srvs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Trigger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ap_srvs-srv:message-val is deprecated.  Use ap_srvs-srv:message instead.")
  (message m))
