...
sshpass -p "odroid" scp -rp -o StrictHostKeyChecking=no $HOME/usma_swarm/usma_files/ROS_Nodes/test.txt odroid@192.168.11.$tail:~/acs_ros_ws/src/autonomy-payload/ap_master/launch/
