...
SITL_LOCATION = 0   # 0 = McMillan, 1 = USMA/Range11, 2 = USMA/RiverCts
...
BASE_REL_ALT = 10.0   # Base rel_alt for "stacked" behaviors (original 100)
...
if SITL_LOCATION == 2:
    ...
    BATTLE_CUBE_SW_LAT = 35.7214444888298    # Latitude of the battle cube SW corner
    BATTLE_CUBE_SW_LON = -120.77377763463352  # Longitude of the battle cube SW corner
...
if SITL_LOCATION == 2:
    ...
    RED_STAGE_SW_LAT = 35.7214444888298
    RED_STAGE_SW_LON = -120.77377763463352
    STAGE_CUBE_WIDTH = 900
...
def get_battleboxes():
    ...
    ctr1 = (35.7214444888298, -120.77377763463352)
...
if SITL_LOCATION == 2:
    ...
    GOAL1 = ( 35.722783, -120.769350, 279.5 )
    GOAL2 = ( 35.721602, -120.766319, 281.9 )
