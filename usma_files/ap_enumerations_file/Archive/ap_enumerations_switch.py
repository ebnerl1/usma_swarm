...
SITL_LOCATION = 0   # 0 = McMillan, 1 = USMA/Range11
...
MIN_REL_ALT = 30.0     # Minimum relative altitude that a controller can order; was 70.0
...
if SITL_LOCATION == 1:
    GOAL_POSITS['blue'] = ( 41.359730, -74.031820 )
    GOAL_POSITS['red'] = ( 41.357625, -74.031650 )
else:
